...
const PASSOS: Passo[] = [
  ...
  { id: "expand-manha", rotulo: "Expandir singles manhã em carrosséis", url: "/api/admin/campanha/expandir-singles?slot=manha" },
  ...
  { id: "expand-tarde", rotulo: "Expandir singles tarde em carrosséis", url: "/api/admin/campanha/expandir-singles?slot=tarde" },
