...
const FASES: Fase[] = [
  ...
  { id: "img-1", rotulo: "Imagens manhã, dias 1-10", url: "/api/admin/campanha/imagens-replicate?inicio=1&fim=10&slot=manha&strategy=prefer-existing" },
  { id: "img-2", rotulo: "Imagens manhã, dias 11-20", url: "/api/admin/campanha/imagens-replicate?inicio=11&fim=20&slot=manha&strategy=prefer-existing" },
  { id: "img-3", rotulo: "Imagens manhã, dias 21-30", url: "/api/admin/campanha/imagens-replicate?inicio=21&fim=30&slot=manha&strategy=prefer-existing" },
